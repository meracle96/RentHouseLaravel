              ...
              @if (Auth::user())
                <li class="dropdown" style="margin-right:30px;">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="{{route('depan.profil.pemesanankos',['id'=>Auth::user()->id])}}">List Pemesanan Kos</a></li>
                        <li><a href="{{route('depan.profil.pemesanankontrakan',['id'=>Auth::user()->id])}}">List Pemesanan Kontrakan</a></li>
    ...
    <div class="navbar__row js-navbar-row"><a href="index.html" class="navbar__brand">
      ...
      <div id="navbar-collapse-1" class="navbar__wrap">
        <ul class="navbar__nav">
          ...
          <li class="navbar__item"><a href="/kontrakan" class="navbar__link">Cari Rumah Kontrakan</a></li>
          <li class="navbar__item"><a href="/rumahkos" class="navbar__link">Cari Kamar Kost</a></li>
