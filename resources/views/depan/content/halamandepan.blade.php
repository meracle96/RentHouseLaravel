      ...
      <div class="site-wrap js-site-wrap">
                ...
                <div class="container">
                  <div class="row">
                    <div class="banner__caption">
                      ...
                      <h3 class="banner__subtitle">Temukanlah Rumah Kontrakan ataupun Kamar Kost yang sesuai dengan selera anda.</h3><span class="banner__btn">Ayoo Cari !!!</span>
        ...
        <div class="widget js-widget widget--landing widget--gray">
          <div class="widget__header">
            <h2 class="widget__title">Daftar Rumah Kost dan Kontrakan</h2>
            <h5 class="widget__headline">Daftar Rumah Kontrakan dan Kos yang ada di Kota Pontianak dan sekitarnya</h5>
          </div>
          <div class="widget__content">
            ...
            <div class="tab tab--properties">
              ...
              <ul role="tablist" class="nav tab__nav">
                <li class="active"><a href="#tab-popular" aria-controls="tab-popular" role="tab" data-toggle="tab" class="properties__btn js-pgroup-tab">Rumah Kontrakan Terbaru</a></li>
                <li><a href="#tab-recent" aria-controls="tab-recent" role="tab" data-toggle="tab" class="properties__btn js-pgroup-tab"> Rumah Kos Terbaru</a></li>
              </ul>
              <!-- Tab panes-->
              ...
              <div class="container">
                <div class="feature__content">
                  <div class="feature__header">
                    <h3 data-sr="enter right ease-in-out 150px" class="feature__title">Kelebihan Carikos.com</h3>
                    <br>
                  </div>
                  ...
                  <div class="feature__list">
                    <div data-sr="enter right ease 150px" class="feature__item">
                      ...
                      <div class="feature__item-content">
                        ...
                        <div class="feature__text">
                          <p>Anda tidak perlu membayar biaya pemasaran Rumah Kos dan Kontrakan yang ingin anda pasarkan.</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div data-sr="enter right ease 250px" class="feature__item">
                      ...
                      <div class="feature__item-content">
                        ...
                        <div class="feature__text">
                          <p>Para pemilik Rumah kos dan Kontrakan dapat memasarkan lebih dari 1 Rumah Kos dan Kontrakan.</p>
                        </div>
                      </div>
                    </div>
                    <!-- end of block .feature__item-->
                    <div data-sr="enter right ease 150px" class="feature__item">
                      ...
                      <div class="feature__item-content">
                        ...
                        <div class="feature__text">
                          <p>Anda dapat memberi penilaian dan review kepada Pemilik, Rumah Kos dan Kontrakan yang ditawarkan.</p>
                        </div>
                      </div>
                    </div>
                    <!-- end of block .feature__item-->
                    <div data-sr="enter right ease 250px" class="feature__item">
                      ...
                      <div class="feature__item-content">
                        ...
                        <div class="feature__text">
                          <p>Anda bisa mencari Rumah Kos dan Kontrakan dengan sangat mudah. Anda juga bisa mencari Rumah Kos dan Kontrakan sesuai dengan Kecamatan.</p>
                        </div>
                      </div>
                    </div>
                    <!-- end of block .feature__item-->
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div data-sr="enter right move 0 over 0 wait 1s" data-animate-callback="countUp" data-animate-end="achievement__item--animate-end" class="achievement__item">
                    ...
                    <div data-count-end="{{ $jlhkos }}" data-count-duration="1" class="achievement__counter achievement__counter--lg js-count-up"></div>
                    <div class="achievement__counter">{{ $jlhkos }}</div>
                    <div class="achievement__name">Kamar Kost</div>
                  </div>
                  <div data-sr="enter right move 0 over 0 wait 1.5s" data-animate-callback="countUp" data-animate-end="achievement__item--animate-end" class="achievement__item">
                    ...
                    <div class="achievement__name">Rumah Kontrakan</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="widget js-widget widget--landing">
          <div class="widget__header">
            ...
            <h5 class="widget__headline">Testimoni para Pelanggan dan Pemilik Rumah Kos dan Kontrakan</h5>
          </div>
          <div class="widget__content">
            ...
            <div id="review-slider" class="review review--wide">
              <div class="review__slider js-slick-slider">
                <div class="review__item">
                  <div class="review__photo"><img src="{{asset('/images/hafifi.jpg')}}" alt="ALT" class="review__photo-img"></div>
                  <div class="review__details"><span class="review__name">Muhammad Noor Hafifi</span><span class="review__post">Pemilik Rumah Kos dan Kontrakan</span>
                  ...
                  <div class="review__info">
                    ...
                    <p>Carikos.com sangat membantu saya dalam memasarkan Rumah Kos dan Kontrakan saya.
                    </p>
                ...
                <div class="review__item">
                  <div class="review__photo"><img src="{{asset('/images/daus.jpg')}}" alt="ALT" class="review__photo-img"></div>
                  <div class="review__details"><span class="review__name">Muhammad Firdaus</span><span class="review__post">Mahasiswa</span>
                    <div class="review__stars"><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i></div>
                  </div>
                  <div class="review__info">
                    <div class="review__info-quote review__info-quote--open">&rdquo;</div>
                    <p>Saya bisa mencari Rumah Kos untuk tempat tinggal di wilayah yang saya inginkan dengan mudah, proses pemesanan juga terbilang sangat mudah.
                    </p>
                    <div class="review__info-quote review__info-quote--close">&ldquo;</div>
                  </div>
                  <div class="clearfix"></div>
                ...
                <div class="review__item">
                  <div class="review__photo"><img src="{{asset('/images/fadhlu.jpg')}}" alt="ALT" class="review__photo-img"></div>
                  <div class="review__details"><span class="review__name">Fadhlurohman</span><span class="review__post">Pemilik Rumah kos dan Kontrakan</span>
                    <div class="review__stars"><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i></div>
                  </div>
                  <div class="review__info">
                    <div class="review__info-quote review__info-quote--open">&rdquo;</div>
                    <p>Sangat mudah untuk digunakan , informasi yang diberikan juga cukup jelas. Proses pemasarannya juga sangat mudah.
                    </p>
                    <div class="review__info-quote review__info-quote--close">&ldquo;</div>
                  </div>
                  <div class="clearfix"></div>
