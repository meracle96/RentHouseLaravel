          ...
          <div class="container">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                <h1 class="text-center">Tambah Kos</h1>
                <br>
                <form enctype="multipart/form-data" action="{{ route('rumahkos.store') }}" method="post">
                  {{ csrf_field() }}
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="jumlahkamar" class="form-control" required="true">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="luaskamar" class="form-control" required="true">
                  </div>
                  <div class="form-group">
