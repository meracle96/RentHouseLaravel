      ...
      <div class="row">
        <div class="site site--main">
          <header class="site__header">
            <h1 class="site__title">Kos</h1>
            <h3>Jumlah :<strong> {{ $jumlahkos }} Kos</strong></h3>
            <a href="{{ route('rumahkos.create' )}}" class="btn btn-primary" style="margin-right:15px;">Tambah Kos</a>
            <a href="/kossaya" class="btn btn-warning">Kos Saya</a>
          </header>
                      ...
                      <div class="properties properties--grid">
                        ...
                        <div class="properties__details">
                          <div class="properties__info"><a href="{{ route('rumahkos.show',['id'=> $kos->id])}}" class="properties__address"><span class="properties__address-street">{{ $kos->judul }}</span><span class="properties__address-city">{{ $kos->alamat }}</span></a>
                            ...
                            <div class="properties__params--mob"><a href="{{ route('rumahkos.show',['rumahkos'=> $kos->id])}}" class="properties__more">View details</a><span class="properties__params">Built-Up - 65 Sq Ft</span><span class="properties__params">Land Size - 110 Sq Ft</span></div>
                          </div>
                        </div>
