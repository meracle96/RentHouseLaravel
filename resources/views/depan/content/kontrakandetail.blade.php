              ...
              <div class="site site--main">
                ...
                <div class="property">
                  ...
                  <div class="property__header">
                    ...
                    @if ($orderkontrakan == 0)
                      <div class="property__actions">
                        <a href="{{route('kontrakan.tambahpemesanan',['id'=>$kontrakan2->id])}}"><button type="button" class="btn--default"><i class="fa fa-star"></i>Booking Kontrakan</button></a>
                      </div>
                    @else
                      <div class="property__actions">
                        <a href="#" onclick="sudahterisi();"><button type="button" class="btn--default"><i class="fa fa-star"></i>Booking Kontrakan</button></a>
                      </div>
                    @endif
                    <div class="property__actions">
                      ...
                      @if ($kontrakan2->user_id == Auth::user()->id)
                        <div class="property__actions" style="float:right">
                          <form action="{{route('kontrakan.destroy',['id'=>$kontrakan2->id])}}" method="post">
                            ...
                            <button type="submit" name="submit" class="btn--default"><i class="fa fa-close"></i>Hapus Kontrakan</button>
                          </form>
                        </div>
                        <div class="property__actions">
                          <a href="{{route('kontrakan.edit',['id'=>$kontrakan2->id])}}">
                            <button type="button" class="btn--default"><i class="fa fa-pencil"></i>Edit Kontrakan</button>
                          </a>
                        </div>
                      @endif
                    @endif
                  ...
                  @if (Auth::user()->id == $kontrakan2->user_id)
                    @if ($orderkontrakan == 1)
                      <div class="property__description js-unhide-block">
                        <h4 class="property__subtitle">Data Penghuni Kontrakan Saat Ini</h4>
                        <table class="table">
                          <thead>
                            <tr>
                              <th>Nama Lengkap</th>
