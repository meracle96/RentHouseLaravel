      ...
      <div class="row">
        ...
        <div class="site site--main">
          <header class="site__header">
            ...
            <h2 class="site__headline">Tentang Carikos.com</h2>
          </header>
          <div class="site__panel"><span class="site__header-text">Carikos.com adalah website yang berfungsi sebagai media pemasaran Rumah Kos dan Kontrakan untuk daerah Pontianak dan sekitarnya.</span></div>


          <header class="site__header">
            <h1 class="site__title">Faq</h1>
            <h2 class="site__headline">Daftar pertanyaan yang sering ditanyakan di website Carikos.com</h2>
          </header>
            ...
            <div class="widget js-widget widget--main">
              <div class="widget__content">
                ...
                <div role="tablist" aria-multiselectable="true" class="faq">
                  ...
                  <dl class="faq__item">
                    <dt id="heading-5" role="tab" class="faq__title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-5" aria-expanded="true" aria-controls="collapse-5" class="faq__expander collapsed">Bagaiamana cara untuk memasarkan Rumah Kontrakan saya ?</a></dt>
                    <dd id="collapse-5" role="tabpanel" aria-labelledby="heading-5" class="faq__content collapse">
                      <div class="faq__body">
                        <p>Untuk memasarkan Rumah Kontrakan, anda diharuskan untuk memiliki akun dan login terlebih dahulu. Kemudian anda dapat menekan tombol Cari Rumah Kontrakan dan kemudian anda dapat menekan tombol Tambah Kontrakan, pastikan anda mengisi seluruh Form Tambah Kontrakan dengan benar. Permintaan pemesaran Rumah kontrakan anda akan segera diproses oleh Admin.</p>
                      </div>
                  ...
                  <!-- end of block .faq__item-->
                  <dl class="faq__item">
                    <dt id="heading-6" role="tab" class="faq__title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-6" aria-expanded="true" aria-controls="collapse-6" class="faq__expander collapsed">Bagaimana cara untuk memasarkan Rumah Kos saya ?</a></dt>
                    <dd id="collapse-6" role="tabpanel" aria-labelledby="heading-6" class="faq__content collapse">
                      <div class="faq__body">
                        <p>Untuk memasarkan Rumah Kos, anda diharuskan untuk memiliki akun dan login terlebih dahulu. Kemudian anda dapat menekan tombol Cari Rumah Kos dan kemudian anda dapat menekan tombol Tambah Kos, pastikan anda mengisi seluruh Form Tambah Kos dengan benar. Permintaan pemesaran Rumah Kos anda akan segera diproses oleh Admin.</p>
                      </div>
        ...
        <div class="sidebar">
          <div class="widget js-widget widget--sidebar widget--dark">
            <div class="widget__header">
              <h2 class="widget__title">Kontrakan / Kos Terbaru</h2>
            </div>
            <div class="widget__content">
