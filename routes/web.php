...
//------------------------------------------------------------------------
Route::get('/kontrakan/pontianakkota', 'FilterKontrakanController@tampilPontianakKota')->name('kontrakan.pontianakkota');
Route::get('/kontrakan/pontianakutara', 'FilterKontrakanController@tampilPontianakUtara')->name('kontrakan.pontianakutara');
Route::get('/kontrakan/pontianaktimur', 'FilterKontrakanController@tampilPontianakTimur')->name('kontrakan.pontianaktimur');
Route::get('/kontrakan/pontianakbarat', 'FilterKontrakanController@tampilPontianakBarat')->name('kontrakan.pontianakbarat');
Route::get('/kontrakan/pontianakselatan', 'FilterKontrakanController@tampilPontianakSelatan')->name('kontrakan.pontianakselatan');
Route::get('/kontrakan/pontianaktenggara', 'FilterKontrakanController@tampilPontianakTenggara')->name('kontrakan.pontianaktenggara');
